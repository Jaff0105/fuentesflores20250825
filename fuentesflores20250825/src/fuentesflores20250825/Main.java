...
public class Main {
    ...
    public static void ingresar_datos(){
        ...
        for(int i = 0; i < edades.length; i++){
            ...
            // Y SE ASIGNA A LA VARIABLE DE EDAD QUE CORRESPONDE SEGÚN LA POSICIÓN
            //LÑA POSICION EN LA ITERACION
            edades[i] = scanner.nextInt();
            
            // PARA CALCULAR EL PROMEDIO, SE REQUIERE SUMAR TODAS LAS EDADES
        ...
        // SE CIERRA EL OBJETO DE TIPO SCANNER
        scanner.close();                  
    }
